...
function Input({ className, type, ...props }: React.ComponentProps<"input">) {
  return (
    <input
      ...
      data-slot="input"
      className={cn(
        "text-sm md:text-lg file:text-foreground placeholder:text-muted-foreground",
        "dark:placeholder:text-foreground selection:bg-primary selection:text-primary-foreground flex h-11 md:h-14 w-full min-w-0 border-b",
